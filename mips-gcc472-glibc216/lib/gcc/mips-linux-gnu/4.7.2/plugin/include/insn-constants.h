...
enum unspec {
  ...
  UNSPEC_MXU2_FMAX = 294,
  UNSPEC_MXU2_FMAXA = 295,
  UNSPEC_MXU2_FMIN = 296,
  UNSPEC_MXU2_FMINA = 297,
  UNSPEC_MXU2_FCLASS = 298,
  UNSPEC_MXU2_MAXA = 299,
  UNSPEC_MXU2_MAXS = 300,
  UNSPEC_MXU2_MAXU = 301,
  UNSPEC_MXU2_MINA = 302,
  UNSPEC_MXU2_MINS = 303,
  UNSPEC_MXU2_MINU = 304,
  UNSPEC_MXU2_SATS = 305,
  UNSPEC_MXU2_SATU = 306,
  UNSPEC_MXU2_SLLI = 307,
  UNSPEC_MXU2_SRAI = 308,
  UNSPEC_MXU2_SRLI = 309,
  UNSPEC_MXU2_SRAR = 310,
  UNSPEC_MXU2_SRARI = 311,
  UNSPEC_MXU2_SRLR = 312,
  UNSPEC_MXU2_SRLRI = 313,
  UNSPEC_MXU2_DOTPS = 314,
  UNSPEC_MXU2_DOTPU = 315,
  UNSPEC_MXU2_DADDS = 316,
  UNSPEC_MXU2_DADDU = 317,
  UNSPEC_MXU2_DSUBS = 318,
  UNSPEC_MXU2_DSUBU = 319,
  UNSPEC_MXU2_LOC = 320,
  UNSPEC_MXU2_LZC = 321,
  UNSPEC_MXU2_BCNT = 322,
  UNSPEC_MXU2_ANDIB = 323,
  UNSPEC_MXU2_NORIB = 324,
  UNSPEC_MXU2_ORIB = 325,
  UNSPEC_MXU2_XORIB = 326,
  UNSPEC_MXU2_NORV = 327,
  UNSPEC_MXU2_BSELV = 328,
  UNSPEC_MXU2_VCVTHS = 329,
  UNSPEC_MXU2_VCVTSD = 330,
  UNSPEC_MXU2_VCVTESH = 331,
  UNSPEC_MXU2_VCVTEDS = 332,
  UNSPEC_MXU2_VCVTOSH = 333,
  UNSPEC_MXU2_VCVTODS = 334,
  UNSPEC_MXU2_VCVTSSW = 335,
  UNSPEC_MXU2_VCVTSDL = 336,
  UNSPEC_MXU2_VCVTUSW = 337,
  UNSPEC_MXU2_VCVTUDL = 338,
  UNSPEC_MXU2_VCVTSWS = 339,
  UNSPEC_MXU2_VCVTSLD = 340,
  UNSPEC_MXU2_VCVTUWS = 341,
  UNSPEC_MXU2_VCVTULD = 342,
  UNSPEC_MXU2_VCVTRWS = 343,
  UNSPEC_MXU2_VCVTRLD = 344,
  UNSPEC_MXU2_VTRUNCSWS = 345,
  UNSPEC_MXU2_VTRUNCSLD = 346,
  UNSPEC_MXU2_VTRUNCUWS = 347,
  UNSPEC_MXU2_VTRUNCULD = 348,
  UNSPEC_MXU2_VCVTQESH = 349,
  UNSPEC_MXU2_VCVTQEDW = 350,
  UNSPEC_MXU2_VCVTQOSH = 351,
  UNSPEC_MXU2_VCVTQODW = 352,
  UNSPEC_MXU2_VCVTQHS = 353,
  UNSPEC_MXU2_VCVTQWD = 354,
  UNSPEC_MXU2_MADDQ = 355,
  UNSPEC_MXU2_MADDQR = 356,
  UNSPEC_MXU2_MSUBQ = 357,
  UNSPEC_MXU2_MSUBQR = 358,
  UNSPEC_MXU2_MULQ = 359,
  UNSPEC_MXU2_MULQR = 360,
  UNSPEC_MXU2_MTFPU = 361,
  UNSPEC_MXU2_MFCPU = 362,
  UNSPEC_MXU2_MFFPU = 363,
  UNSPEC_MXU2_INSFCPU = 364,
  UNSPEC_MXU2_INSFFPU = 365,
  UNSPEC_MXU2_INSFMXU = 366,
  UNSPEC_MXU2_REPX = 367,
  UNSPEC_MXU2_REPI = 368,
  UNSPEC_MXU2_SHUFV = 369,
  UNSPEC_MXU2_SA1QX = 370,
  UNSPEC_MXU2_LA1QX = 371,
  UNSPEC_MXU2_SA1Q = 372,
  UNSPEC_MXU2_LA1Q = 373,
  UNSPEC_MXU2_CFCMXU = 374,
  UNSPEC_MXU2_CTCMXU = 375,
  UNSPEC_MXU2_FMADD = 376,
  UNSPEC_MXU2_FMSUB = 377,
  UNSPEC_ADDRESS_FIRST = 378
};
#define NUM_UNSPEC_VALUES 379
