...
#define MASK_64BIT (1 << 13)
#define MASK_MIPS16 (1 << 14)
#define MASK_MIPS3D (1 << 15)
#define MASK_LLSC (1 << 16)
#define MASK_LONG64 (1 << 17)
#define MASK_MCU (1 << 18)
#define MASK_MEMCPY (1 << 19)
#define MASK_MICROMIPS (1 << 20)
#define MASK_OCTEON_UNALIGNED (1 << 21)
#define MASK_PAIRED_SINGLE_FLOAT (1 << 22)
#define MASK_RELAX_PIC_CALLS (1 << 23)
#define MASK_SINGLE_FLOAT (1 << 24)
#define MASK_SMARTMIPS (1 << 25)
#define MASK_SOFT_FLOAT_ABI (1 << 26)
...
enum opt_code
{
  ...
  OPT_mmt = 1058,                            /* -mmt */
  OPT_mmxu = 1059,                           /* -mmxu */
  OPT_mmxu2 = 1060,                          /* -mmxu2 */
  OPT_mno_float = 1061,                      /* -mno-float */
  OPT_mno_flush_func = 1062,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1063,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1064,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1065,                     /* -mno-mips3d */
  OPT_mocteon_useun = 1066,                  /* -mocteon-useun */
  OPT_mpaired_single = 1067,                 /* -mpaired-single */
  OPT_mplt = 1068,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1069,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1070,               /* -mrelax-pic-calls */
  OPT_mshared = 1071,                        /* -mshared */
  OPT_msingle_float = 1072,                  /* -msingle-float */
  OPT_msmartmips = 1073,                     /* -msmartmips */
  OPT_msoft_float = 1074,                    /* -msoft-float */
  OPT_msplit_addresses = 1075,               /* -msplit-addresses */
  OPT_msym32 = 1076,                         /* -msym32 */
  OPT_msynci = 1077,                         /* -msynci */
  OPT_mtune_ = 1078,                         /* -mtune= */
  OPT_muclibc = 1079,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1080,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1081,                  /* -mvr4130-align */
  OPT_mxgot = 1082,                          /* -mxgot */
  OPT_n = 1083,                              /* -n */
  OPT_no_canonical_prefixes = 1084,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1085,              /* -no-integrated-cpp */
  OPT_noasmopt = 1086,                       /* -noasmopt */
  ...
  OPT_static_libgcc = 1127,                  /* -static-libgcc */
  OPT_static_libgcj = 1128,                  /* -static-libgcj */
  OPT_static_libgfortran = 1129,             /* -static-libgfortran */
  OPT_static_libgo = 1130,                   /* -static-libgo */
  ...
  OPT_time = 1165,                           /* -time */
  OPT_time_ = 1166,                          /* -time= */
  OPT_tno_android_cc = 1167,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1168,                 /* -tno-android-ld */
  OPT_traditional = 1169,                    /* -traditional */
  OPT_traditional_cpp = 1170,                /* -traditional-cpp */
  OPT_trigraphs = 1171,                      /* -trigraphs */
  OPT_u = 1172,                              /* -u */
  OPT_undef = 1173,                          /* -undef */
  OPT_v = 1174,                              /* -v */
  OPT_version = 1175,                        /* -version */
  OPT_w = 1176,                              /* -w */
  OPT_wrapper = 1177,                        /* -wrapper */
  OPT_x = 1178,                              /* -x */
  OPT_z = 1179,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
